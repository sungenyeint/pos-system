                                ...
                                <div class="form-group">
                                    ...
                                    <select id="product_id" name="product_id" class="form-control @error('product_id') is-invalid @enderror" required>
                                        ...
                                        @foreach ($products as $product)
                                            <option data-cost="{{ $product->unit_cost }}" value="{{ $product->id }}" @if (old('product_id') == $product->id) selected @endif>
                                                {{ $product->name }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="total_cost" name="total_cost" class="form-control @error('total_cost') is-invalid @enderror" value="{{ old('total_cost') }}" maxlength="{{ config('const.default_text_maxlength') }}" placeholder="Total Cost" required>
                                    @error('total_cost')
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="purchase_date" name="purchase_date" class="form-control @error('purchase_date') is-invalid @enderror" value="{{ old('purchase_date') }}" maxlength="{{ config('const.default_text_maxlength') }}" placeholder="YYYY-MM-DD HH:ii" required>
                                    @error('purchase_date')
